...
//    var selectedApplicationAddInfoType : String? = nil
    ...
    @objc fileprivate func addResume(sender: UIBarButtonItem){
        ...
        let applicationToAdd = ApplicationInfo(position: positionToAdd, status: statusToAdd, type: typeToAdd, date: dateToAdd, referral: referralToAdd, companyName: nameToAdd)
